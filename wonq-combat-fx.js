...
.fx.prototype .fx-label{display:none!important}.particle.whisper-wisp{position:absolute;z-index:2;width:var(--w)!important;height:var(--h)!important;border-radius:50%;opacity:0;filter:blur(var(--blur));background:radial-gradient(ellipse at 50% 45%,color-mix(in srgb,var(--mist1) 68%,transparent),color-mix(in srgb,var(--mist2) 38%,transparent) 38%,transparent 72%);box-shadow:0 0 25px color-mix(in srgb,var(--mist2) 25%,transparent);animation:wonqWhisper var(--d) cubic-bezier(.2,.52,.24,1) var(--delay) forwards}.particle.music-note{position:absolute;z-index:3;width:auto!important;height:auto!important;background:transparent!important;box-shadow:none!important;color:var(--thread);font:600 var(--size) Georgia,serif;text-shadow:0 0 12px color-mix(in srgb,var(--thread) 70%,transparent);opacity:0;animation:wonqNote var(--d) ease-out var(--delay) forwards}.particle.spirit-shape{position:absolute;z-index:2;width:var(--w)!important;height:var(--h)!important;border-radius:48% 52% 34% 36%/26% 27% 73% 74%;opacity:0;filter:blur(var(--blur));background:radial-gradient(circle at 50% 17%,color-mix(in srgb,var(--mist1) 72%,transparent) 0 8%,transparent 9%),radial-gradient(ellipse at 50% 60%,color-mix(in srgb,var(--mist2) 45%,transparent) 0 22%,color-mix(in srgb,var(--thread) 14%,transparent) 42%,transparent 71%);animation:wonqGhost var(--d) cubic-bezier(.19,.55,.24,1) var(--delay) forwards}.particle.tale-avatar{position:absolute;z-index:3;left:var(--left,50%);top:54%;width:min(48vw,520px)!important;height:min(48vw,520px)!important;background-image:url('assets/fx/tale-spectres.webp')!important;background-repeat:no-repeat!important;background-size:400% 200%!important;background-position:var(--bx) var(--by)!important;filter:drop-shadow(0 0 24px color-mix(in srgb,var(--mist2) 48%,transparent));opacity:0;animation:wonqAvatar 2.65s ease-out forwards}.tale-reveal .tale-avatar{width:min(33vw,350px)!important;height:min(33vw,350px)!important;top:62%;filter:blur(.3px) drop-shadow(0 0 18px color-mix(in srgb,var(--mist2) 34%,transparent));animation:wonqReveal 2.35s ease-out forwards}.tale-voices .tale-avatar{width:min(29vw,310px)!important;height:min(29vw,310px)!important;top:61%;animation:wonqReveal 2.55s ease-out var(--delay) forwards}.particle.tale-signature{position:absolute!important;z-index:4;left:50%!important;top:53%!important;width:min(55vw,580px)!important;height:min(55vw,580px)!important;transform:translate(-50%,-50%);background:transparent!important;box-shadow:none!important;opacity:1!important}.tale-signature i{position:absolute;display:block;background:var(--thread);box-shadow:0 0 18px var(--thread);opacity:0}.tale1 .tale-signature i{width:6px;height:55%;top:26%;left:var(--p);transform:rotate(18deg);animation:wonqClaw 1.45s ease-out var(--delay) forwards}.tale2 .tale-signature i,.tale5 .tale-signature i{width:3px;height:80%;left:50%;top:10%;transform:rotate(var(--rot));background:linear-gradient(transparent,var(--thread),#fff,transparent);animation:wonqSlash 1.35s ease-out var(--delay) forwards}.tale3 .tale-signature i{width:76px;height:76px;border-radius:50%;left:var(--p);top:43%;background:radial-gradient(circle,var(--mist1),var(--mist2) 38%,transparent 70%);animation:wonqBond 1.75s ease-out var(--delay) forwards}.tale4 .tale-signature i{width:80%;height:3px;left:10%;top:var(--p);background:linear-gradient(90deg,transparent,var(--mist2),var(--thread),transparent);animation:wonqDash 1.25s ease-out var(--delay) forwards}.tale6 .tale-signature i{inset:16%;border:3px solid var(--thread);border-radius:50%;background:transparent;animation:wonqHalo 1.8s ease-out var(--delay) forwards}.tale7 .tale-signature i{width:2px;height:76%;left:var(--p);top:12%;background:linear-gradient(transparent,var(--thread),var(--mist2),transparent);animation:wonqThread 1.8s ease-out var(--delay) forwards}.tale8 .tale-signature i{inset:10%;border-radius:50%;background:radial-gradient(circle,transparent 25%,#07100fb0 62%,transparent 74%);box-shadow:none;animation:wonqDarkVeil 2s ease-out forwards}.particle.illusion-veil{position:absolute;z-index:2;left:50%;top:48%;width:min(48vw,540px)!important;height:min(62vh,520px)!important;border-radius:50%;background:radial-gradient(ellipse,color-mix(in srgb,var(--mist1) 32%,transparent),color-mix(in srgb,var(--mist2) 22%,transparent) 35%,transparent 68%);filter:blur(14px);opacity:0;animation:wonqVeil 2.2s ease-out var(--delay) forwards}.particle.crit-streak{position:absolute;z-index:4;left:50%;bottom:3%;width:3px!important;height:86vh!important;background:linear-gradient(0deg,transparent,var(--thread),#fffbe0,var(--thread),transparent)!important;box-shadow:0 0 18px var(--thread),0 0 42px color-mix(in srgb,var(--mist1) 55%,transparent);opacity:0;animation:wonqStreak 1.4s ease-out forwards}
...
@keyframes wonqReveal{0%{opacity:0;transform:translate(-50%,32%) scale(.62);filter:blur(12px)}28%{opacity:.42;filter:blur(2px)}68%{opacity:.28}100%{opacity:0;transform:translate(-50%,-22%) scale(.93);filter:blur(7px)}}
@keyframes wonqClaw{0%{opacity:0;transform:translateY(28%) rotate(18deg) scaleY(.1)}30%{opacity:.85}65%{opacity:.55;transform:translateY(-8%) rotate(18deg) scaleY(1)}100%{opacity:0;transform:translateY(-32%) rotate(18deg) scaleY(1.15)}}
@keyframes wonqSlash{0%{opacity:0;transform:rotate(var(--rot)) scaleY(.05)}22%{opacity:1}55%{opacity:.7;transform:rotate(var(--rot)) scaleY(1)}100%{opacity:0;transform:rotate(var(--rot)) scaleY(1.1)}}
@keyframes wonqBond{0%{opacity:0;transform:translateX(var(--from)) scale(.4)}34%{opacity:.9}68%{opacity:.55;transform:translateX(0) scale(1)}100%{opacity:0;transform:translateX(0) scale(1.25)}}
@keyframes wonqDash{0%{opacity:0;transform:translateX(-45%) scaleX(.1)}28%{opacity:.9}62%{opacity:.5;transform:translateX(10%) scaleX(1)}100%{opacity:0;transform:translateX(45%) scaleX(.65)}}
@keyframes wonqHalo{0%{opacity:0;transform:scale(.35)}30%{opacity:.8}68%{opacity:.45;transform:scale(1)}100%{opacity:0;transform:scale(1.28)}}
@keyframes wonqThread{0%{opacity:0;transform:translateY(28%) rotate(var(--rot)) scaleY(.2)}30%{opacity:.7}70%{opacity:.4;transform:translateY(-8%) rotate(var(--rot)) scaleY(1)}100%{opacity:0;transform:translateY(-25%) rotate(var(--rot)) scaleY(1.1)}}
@keyframes wonqDarkVeil{0%{opacity:0;transform:scale(.5)}35%{opacity:.75}70%{opacity:.48;transform:scale(1)}100%{opacity:0;transform:scale(1.25)}}
...
playFX=function(type,label){
 ...
 const tale=/^tale/.test(type),draw=/^Conte (mémorisé|choisi)$/.test(label||''),voices=label==='Deux voix dans la fumée',variant=voices?'tale-voices':tale?(draw?'tale-reveal':'tale-offer'):label==='Inspiration bardique'?'inspiration':/invisibilit|illusion/i.test(label||'')?'illusion-prototype':type==='psychic'?'whisper':type==='heal'?'heal-prototype':type==='physical'?'impact-prototype':type==='crit'?'crit-prototype':type==='spirit'?'spirit-prototype':type==='rest'?'rest-prototype':'',w=Math.max(innerWidth,700),h=Math.max(innerHeight,700);
 const avatarFor=(n,left='50%',delay='0s')=>{n=Math.max(1,Math.min(8,+n||1));const avatar=document.createElement('i'),x=['0%','33.333%','66.667%','100%'][(n-1)%4],y=n<=4?'0%':'100%';avatar.className='particle tale-avatar';avatar.style.cssText=`--bx:${x};--by:${y};--left:${left};--delay:${delay}`;box.appendChild(avatar)};
 const addTaleSignature=n=>{const sig=document.createElement('span');sig.className='particle tale-signature';for(let i=0;i<4;i++){const mark=document.createElement('i');mark.style.cssText=`--delay:${i*.09}s;--p:${n===1?32+i*12:n===3?(i%2?58:28):n===4?34+i*10:30+i*13}%;--rot:${n===5?(i%2?-43:43):n===2?-48+i*9:-18+i*12}deg;--from:${i%2?-90:90}px`;sig.appendChild(mark)}box.appendChild(sig)};
 ...
 }else if(variant==='tale-reveal'){
  addWisp(10);avatarFor(type.slice(4));
 }else if(variant==='tale-voices'){
  addWisp(13);const nums=(wonqFxRecordContext?.text?.match(/\b[1-8]\b/g)||[]).slice(0,2);avatarFor(nums[0]||1,'37%','0s');avatarFor(nums[1]||2,'63%','.13s');
 }else if(variant==='tale-offer'){
  addWisp(18);const n=Math.max(1,Math.min(8,+type.slice(4)||1));avatarFor(n);addTaleSignature(n);for(let i=0;i<4;i++){const p=document.createElement('i');p.className='particle spirit-shape';p.style.cssText=`left:${12+Math.random()*76}%;top:${91+Math.random()*12}%;--w:${45+Math.random()*48}px;--h:${115+Math.random()*105}px;--blur:${6+Math.random()*7}px;--x:${(-.07+Math.random()*.14)*w}px;--y:${-(.38+Math.random()*.34)*h}px;--d:${2.1+Math.random()*.7}s;--delay:${.12+Math.random()*.38}s;--alpha:${.1+Math.random()*.1}`;box.appendChild(p)}
...
let wonqFxRecordContext=null;
const wonqRecordBase=record;
record=function(title,text,type='',fxType=type){wonqFxRecordContext={title,text};const result=wonqRecordBase(title,text,type,fxType);wonqFxRecordContext=null;if(fxType==='rest')playFX('rest',title);return result};
