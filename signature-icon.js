...
/* Header tablette/desktop calé sur la structure de Silas */
@media(min-width:768px){
.top{display:grid!important;grid-template-columns:1.4fr 2fr!important;gap:14px!important;align-items:stretch!important}
.identity{padding:18px 118px 18px 18px!important;min-height:0!important}.identity h1{font-size:clamp(2rem,5vw,3.6rem)!important;line-height:.95!important;margin:.25rem 0 .55rem!important}.identity p{font-size:inherit!important;line-height:1.45!important;white-space:normal!important;overflow:visible!important}.identity .motto{margin-top:9px!important;font-size:.9rem!important;white-space:normal!important;overflow:visible!important}.signature-icon{right:12px!important;top:50%!important;width:96px!important;height:96px!important;transform:translateY(-50%) rotate(-4deg)!important}
.dashboard{display:grid!important;grid-template-columns:2fr repeat(7,1fr)!important;grid-auto-rows:auto!important;padding:12px!important;gap:8px!important;overflow:visible!important}.dashboard>.secondary{display:none!important}.dashboard>.stat,.dashboard>.hpstat{display:block!important;grid-column:auto!important;grid-row:auto!important;padding:9px!important;border-radius:11px!important;text-align:left!important}.dashboard>.hpstat>small{display:block!important}.dashboard .hpgrid{display:grid!important;grid-column:auto!important;grid-row:auto!important;grid-template-columns:1fr 1fr!important;gap:5px!important;margin-top:5px!important}.dashboard .hp-tools{display:grid!important;grid-column:auto!important;grid-row:auto!important;grid-template-columns:70px 1fr 1fr!important;gap:5px!important;margin-top:6px!important}.dashboard>.stat b{font-size:1.22rem!important;line-height:1.45!important}.dashboard>.stat small{font-size:.63rem!important;line-height:1.45!important}.dashboard .number{height:auto!important;min-height:0!important;padding:7px!important;font-size:inherit!important}.dashboard .hp-tools button{height:auto!important;min-height:35px!important;padding:0!important;font-size:.74rem!important}}
@media(min-width:768px) and (max-width:1100px){.dashboard{grid-template-columns:2fr repeat(3,1fr)!important}}
`;
