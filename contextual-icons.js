...
.context-glyph-button{display:inline-flex!important;align-items:center;justify-content:center;gap:7px}.context-glyph-button .wonq-glyph{width:25px;height:25px}.quick-slots-label{display:flex;align-items:center;gap:6px}.quick-slots-label .wonq-glyph{width:25px;height:25px}
...
@media(max-width:767px){.nav button{gap:4px}.nav .wonq-glyph{width:17px;height:17px}.context-panel:after{width:72px;height:72px}.context-glyph-button .wonq-glyph{width:22px;height:22px}}
`;
