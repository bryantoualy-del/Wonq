...
.context-glyph-button{display:inline-flex!important;align-items:center;justify-content:center;gap:7px}.context-glyph-button .wonq-glyph{width:25px;height:25px}.turn-conc{display:grid!important;grid-template-columns:24px minmax(0,1fr)!important;grid-template-rows:auto auto!important;column-gap:6px!important;min-width:148px!important;min-height:64px!important}.turn-conc .wonq-glyph{grid-column:1;grid-row:1;width:24px;height:24px;align-self:center}.turn-conc small{grid-column:2;grid-row:1;align-self:center;white-space:nowrap;letter-spacing:.045em!important}.turn-conc b{grid-column:1/-1;grid-row:2;white-space:normal!important;overflow:visible!important;text-overflow:clip!important;overflow-wrap:anywhere;line-height:1.15!important}.quick-slots-label{display:flex;align-items:center;gap:6px}.quick-slots-label .wonq-glyph{width:25px;height:25px}
