...
@keyframes wonqTear{0%{height:0;opacity:0}14%{height:62vh;opacity:1}28%{width:92px;height:68vh;opacity:1}72%{width:92px;height:68vh;opacity:.96}86%{width:74px;height:69vh;opacity:.72}100%{width:0;height:72vh;opacity:0}}
...
@keyframes wonqShard{0%{opacity:0;transform:rotate(var(--r)) translateX(0) scaleX(.06)}22%{opacity:1}62%{opacity:.76;transform:rotate(var(--r)) translateX(var(--dx)) scaleX(1)}100%{opacity:0;transform:rotate(var(--r)) translateX(var(--dx)) scaleX(.7)}}
...
playFX=function(type,label){
 ...
 else if(scene==='door'){theme='fx-register';duration=3200;shown='LE PASSAGE';addPages(root,10);addMist(root,12);root.appendChild(node('tear'))}
