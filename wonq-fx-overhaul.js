...
@keyframes wonqTear{0%{height:0;opacity:0}18%{height:62vh;opacity:1}68%{width:120px;height:66vh;opacity:.78}86%{width:92px;height:68vh;opacity:.58}100%{width:0;height:70vh;opacity:0}}
30%{opacity:.2}78%{opacity:.14}100%{opacity:0;transform:translate(-50%,-16%) scale(.92)}}
...
playFX=function(type,label){
 ...
 else if(scene==='door'){theme='fx-register';duration=2300;shown='LE PASSAGE';addPages(root,10);addMist(root,10);root.appendChild(node('tear'))}
