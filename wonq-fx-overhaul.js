...
.fx.wonq-cinematic .portal{position:absolute;left:50%;top:53%;width:min(44vw,420px);height:min(72vh,620px);transform:translate(-50%,-50%);opacity:0;animation:wonqPortalOpen 2.35s cubic-bezier(.2,.7,.2,1) forwards}
.fx.wonq-cinematic .portal:before{content:'';position:absolute;inset:0;border-radius:45% 55% 48% 52%/10% 12% 88% 90%;background:radial-gradient(ellipse at 50% 50%,#121827 0 24%,#2f2143 34%,#4f7f7a55 48%,transparent 70%);box-shadow:inset 0 0 58px #0a0d16,0 0 24px #d9c79a66,0 0 58px #78b9ad44;filter:blur(.2px)}
.fx.wonq-cinematic .portal:after{content:'';position:absolute;inset:-4%;border-radius:46% 54% 47% 53%/10% 14% 86% 90%;border:2px solid #e8dcc3bb;box-shadow:0 0 16px #f0d89c,0 0 38px #7db8af,inset 0 0 28px #9572ad55;filter:drop-shadow(0 0 16px #8dbfb466);animation:wonqPortalBreathe 1.15s ease-in-out .45s 2 alternate}
.fx.wonq-cinematic .portal-depth{position:absolute;left:50%;top:53%;width:min(36vw,335px);height:min(61vh,520px);transform:translate(-50%,-50%);border-radius:44% 56% 48% 52%/10% 12% 88% 90%;overflow:hidden;opacity:0;animation:wonqPortalDepth 2.25s ease-out .28s forwards}
.fx.wonq-cinematic .portal-depth:before{content:'';position:absolute;inset:-15%;background:radial-gradient(circle at 48% 38%,#8ec4bc1f 0 6%,transparent 7%),radial-gradient(circle at 57% 68%,#ad8bbb20 0 5%,transparent 6%),repeating-radial-gradient(ellipse at 50% 50%,#24303a 0 7%,#15111e 12%,#0b0d13 20%,#171325 28%);filter:blur(2px);animation:wonqPortalTunnel 1.8s linear .3s forwards}
.fx.wonq-cinematic .portal-depth:after{content:'';position:absolute;left:50%;top:8%;width:2px;height:84%;transform:translateX(-50%);background:linear-gradient(transparent,#d9e9df55,#8db8b055,#b99ac744,transparent);box-shadow:0 0 18px #a7d2c8;opacity:.55}
.fx.wonq-cinematic .portal-smoke{position:absolute;left:var(--x);top:var(--y);width:var(--w);height:var(--h);border-radius:50%;background:radial-gradient(ellipse,#f0eadf30,#7bb6ad2b 38%,#6e547923 58%,transparent 72%);filter:blur(var(--b));opacity:0;animation:wonqPortalSmoke var(--d) ease-out var(--delay) forwards}
.fx.wonq-cinematic .portal-pull{position:absolute;left:50%;top:53%;width:min(72vw,700px);height:min(72vw,700px);transform:translate(-50%,-50%);border-radius:50%;background:repeating-conic-gradient(from 0deg,transparent 0 18deg,#c6dbd115 19deg 20deg,transparent 21deg 42deg);opacity:0;animation:wonqPortalPull 2.15s ease-out .6s forwards}
.fx.wonq-cinematic .portal-specter{position:absolute;left:var(--x);top:var(--y);width:var(--w);height:var(--h);border-radius:48% 52% 34% 36%/26% 27% 73% 74%;background:radial-gradient(circle at 50% 17%,#ecf2e94b 0 7%,transparent 8%),radial-gradient(ellipse at 50% 60%,#7bb8af2f 0 22%,#7a65892a 42%,transparent 70%);filter:blur(1px);opacity:0;animation:wonqPortalSpecter var(--d) ease-out var(--delay) forwards}
...
@keyframes wonqPortalOpen{0%{opacity:0;clip-path:inset(50% 49% 50% 49%);filter:blur(7px)}18%{opacity:.88;clip-path:inset(16% 44% 14% 44%);filter:blur(2px)}38%{opacity:1;clip-path:inset(0 10% 0 10%);filter:blur(.3px)}74%{opacity:.98;clip-path:inset(0 0 0 0)}88%{opacity:.72;clip-path:inset(3% 24% 3% 24%)}100%{opacity:0;clip-path:inset(45% 49% 45% 49%);filter:blur(5px)}}
@keyframes wonqPortalBreathe{from{transform:scale(.98);opacity:.72}to{transform:scale(1.035);opacity:1}}
@keyframes wonqPortalDepth{0%{opacity:0;transform:translate(-50%,-50%) scaleX(.08)}24%{opacity:.72;transform:translate(-50%,-50%) scaleX(.5)}44%{opacity:1;transform:translate(-50%,-50%) scaleX(1)}78%{opacity:.9}100%{opacity:0;transform:translate(-50%,-50%) scaleX(.06)}}
@keyframes wonqPortalTunnel{0%{transform:scale(1.45) rotate(0deg)}70%{transform:scale(.86) rotate(5deg)}100%{transform:scale(.72) rotate(7deg)}}
@keyframes wonqPortalSmoke{0%{opacity:0;transform:translate(-50%,10%) scale(.55)}22%{opacity:.4}70%{opacity:.25}100%{opacity:0;transform:translate(calc(-50% + var(--dx)),calc(-40% + var(--dy))) scale(1.55)}}
@keyframes wonqPortalPull{0%{opacity:0;transform:translate(-50%,-50%) scale(1.2) rotate(0deg)}35%{opacity:.24}80%{opacity:.18;transform:translate(-50%,-50%) scale(.78) rotate(22deg)}100%{opacity:0;transform:translate(-50%,-50%) scale(.52) rotate(34deg)}}
@keyframes wonqPortalSpecter{0%{opacity:0;transform:translate(-50%,10%) scale(.7)}30%{opacity:.2}78%{opacity:.14}100%{opacity:0;transform:translate(-50%,-16%) scale(.92)}}
...
@media(max-width:767px){.fx.wonq-cinematic .tale-avatar-cine{width:min(76vw,360px);height:min(76vw,360px)}.fx.wonq-cinematic .outline{width:58vw;height:48vh}.fx.wonq-cinematic .face{filter:blur(.2px) drop-shadow(0 0 12px #8fc7be55)}.fx.wonq-cinematic .portal{width:min(68vw,320px);height:min(58vh,470px)}.fx.wonq-cinematic .portal-depth{width:min(55vw,260px);height:min(49vh,395px)}.fx.wonq-cinematic .portal-pull{width:92vw;height:92vw}}
`;
...
playFX=function(type,label){
 ...
 else if(scene==='door'){theme='fx-register';duration=2550;shown='LE PASSAGE';
   addMist(root,8);
   for(let i=0;i<18;i++)root.appendChild(node('portal-smoke',`--x:${14+Math.random()*72}%;--y:${72+Math.random()*24}%;--w:${70+Math.random()*140}px;--h:${110+Math.random()*190}px;--b:${10+Math.random()*15}px;--d:${1.55+Math.random()*.65}s;--delay:${Math.random()*.32}s;--dx:${-110+Math.random()*220}px;--dy:${-180-Math.random()*250}px`));
   root.appendChild(node('portal-pull'));
   root.appendChild(node('portal'));
   root.appendChild(node('portal-depth'));
   for(let i=0;i<4;i++)root.appendChild(node('portal-specter',`--x:${36+Math.random()*28}%;--y:${34+Math.random()*44}%;--w:${34+Math.random()*30}px;--h:${75+Math.random()*75}px;--d:${1.5+Math.random()*.45}s;--delay:${.45+i*.13}s`));
   for(let i=0;i<5;i++)root.appendChild(node('page',`--x:${26+Math.random()*48}%;--y:${52+Math.random()*26}%;--w:${24+Math.random()*22}px;--h:${32+Math.random()*28}px;--r:${-24+Math.random()*48}deg;--dx:${-55+Math.random()*110}px;--dy:${-65-Math.random()*85}px;--d:${1.3+Math.random()*.35}s;--delay:${.5+Math.random()*.25}s`));
 }
